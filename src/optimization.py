...
homerow_coef=0.9
relative_weighting=np.array([1.4,1.1,1.,1.,1.4*homerow_coef,1.1*homerow_coef,1.*homerow_coef,1.*homerow_coef])
index=[0,0,0,1]*2
majeur=[0,0,1,0]*2
annulaire=[0,1,0,0]*2
...
def layout_cost(layout, char_freqs, bigram_freq,ergo_chords):
    ...
    total_cost+=same_col_chords*100
    total_cost+=bigram_cost*2

    total_cost+=prohibited_chords*100
    return total_cost
